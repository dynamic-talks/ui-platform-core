...
const config = new ConfigurationReader(/* TODO: add params */).getConfig();

const serverConfig = new ServerConfigurationManager(config);
const clientConfig = new ConfigurationManager(serverConfig.getClientConfiguration());
...
const qaServerConfig = new ServerConfigurationManager(qaConfig);
