 ...
 */
export function createServerIocContainer({ baseConfigPath, configPath, assetsManifestPath}) {
  ...
  iocContainer.registerAll({
    ...
    manifestManager: iocFactory(() => new AssetsManifestManager(require(assetsManifestPath))),
    config: iocFactory(createServerConfigurationManager),
